        ...
        <section class="hero bg-image" data-image-src="images/img/bg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Reserve a Table & Dine with Us </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>View our Dishes</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">2. Dine With Us</span></h4> </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Easy to make Reservation</h2>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Login</h3>
                                    <!-- <p>We have resumed food availability in compliance with the relaxation of local limits.</p> -->
                                </div>
                            </div>
                        </div>
