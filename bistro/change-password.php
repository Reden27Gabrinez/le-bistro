            ...
            <div class="col-sm-6 mt-5 mb-5">
                ...
                <div class="row">
                    <div class="col-6 my-3">
                        <p class="display-6 fw-bolder mt-2">PASSWORD</p>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="container">
                            ...
                            ?>
                                    ...
                                    <div class="alert alert-dismissible text-center">
                                        <b><span id="insertHere"></span></b>
                                    </div>
                        </div>

                        <form method="POST" name="changepass" action="class.php" onSubmit="return valid();">
                            <div class="form-group">
                                <div class="form-floating">
                                    <input required name="currentpassword" class="form-control text-monospace" type="password" id="cpass" placeholder="Cpass">
                                    <label for="name">Current Password</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-floating">
                                    <input required name="newpassword" class="form-control text-monospace" type="password" id="npass" placeholder="npass">
                                    <label for="">New Password</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-floating">
                                    <input required  name="confirmpassword" class="form-control text-monospace" type="password" id="rpass" placeholder="rpass">
                                    <label for="number">Re-type Password</label>
                                </div>
                            </div>
                            <input name="update_pass" id="pass_validate" type="submit" value="Update" class="btn btn-success float-end">
                        </form>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        function valid()
        {
            ...
            {
                document.getElementById('insertHere').innerHTML = '<div>New Pass and Re-type Pass Doesnt Match</div>';
