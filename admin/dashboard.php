            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><i class="fa fa-table f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from book WHERE Status = '2' ";
                                        $result=mysqli_query($db,$sql); 
                                            $rws=mysqli_num_rows($result);
                                            
                                            echo $rws;?></h2>
                                    <p class="m-b-0">Reservation Successfull</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <i class="fa fa-money f-s-40" aria-hidden="true"></i>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php 
